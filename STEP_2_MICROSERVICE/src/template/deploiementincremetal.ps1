...
$suffixestep1=Read-Host "Entrez le suffixe utilisé à l'étape 1"
$rgname="cna"+ $suffixe +"-rg"
$rgnamestep1="cna"+ $suffixestep1 +"-rg"
$accountname="cna"+$suffixestep1+"storage"
...
$cosmosdbname="cnacosmosdb"+$suffixestep1
...
$cosmosdbKey=az cosmosdb keys list -g $rgnamestep1 -n $cosmosdbname --query primaryMasterKey
...
$accountkey=az storage account keys list -n $accountname -g $rgnamestep1 --query [0].value
