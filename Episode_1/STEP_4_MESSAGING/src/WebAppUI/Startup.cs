...
namespace CnAppForAzureDev
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<HttpCatalogClient>(httpClient =>
            {
                httpClient.BaseAddress = new Uri(Configuration["CatalogItemBaseAddressUrl"]);
                httpClient.DefaultRequestHeaders.Add("Accept", "Application/json");
            });
            services.AddTransient<IHttpCatalogClient, HttpCatalogClient>();
        ...
        private void ConfigureRepositories(IServiceCollection services)
        {
            ...
            //TODO : Utilisation d'un Singleton
